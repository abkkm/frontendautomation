package com.abkkm.resilience.aspect;

import com.abkkm.resilience.annotation.EnableCircuitBreaker;
...
public class CircuitBreakerAspect {
    ...
    @Around(value = "@annotation(com.abkkm.resilience.annotation.EnableCircuitBreaker)")
